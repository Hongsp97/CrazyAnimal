...
public class GameManager : MonoBehaviour
{
    ...
    {
        GameObject.Find("GameOverUi").transform.Find("BlueCanvas").gameObject.SetActive(true);
    }
    public void isRedWin()
    {
        GameObject.Find("GameOverUi").transform.Find("RedCanvas").gameObject.SetActive(true);
    }
